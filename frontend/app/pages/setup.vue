...
useHead({ title: 'Configuration initiale · Rocket Mailer' })
    ...
    <UCard class="w-full max-w-md" data-testid="setup">
      ...
      <form class="flex flex-col gap-4" @submit.prevent="submit">
        ...
        <UFormField
          ...
          required
          hint="SETUP_TOKEN"
          help="Défini dans la configuration du serveur (.env) par la personne qui a installé Rocket Mailer."
        >
