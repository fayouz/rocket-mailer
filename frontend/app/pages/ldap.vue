...
useHead({ title: 'Annuaire LDAP · Rocket Mailer' })
  ...
  <UDashboardPanel id="ldap">
    ...
    <template #body>
      <form class="mx-auto flex w-full max-w-4xl flex-col gap-6" data-testid="ldap-form" @submit.prevent="save">
        ...
        <UPageCard title="Utilisateurs" description="Quelles entrées deviennent des comptes Rocket Mailer, et comment lire leurs informations.">
          <div class="grid gap-3 sm:grid-cols-2">
            ...
            <UFormField label="Groupe des administrateurs (DN)" class="sm:col-span-2" help="Ses membres reçoivent le rôle administrateur. Vide : les administrateurs sont gérés dans Rocket Mailer.">
