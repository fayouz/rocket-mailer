#!/bin/sh
# Updates a Rocket Mailer installed without Docker (git clone of the repository), in place:
...
#   UPDATE_RESTART_COMMAND   command restarting the services, e.g. "sudo systemctl restart rocket-mailer-front"
...
step "Rocket Mailer: $(git describe --tags --always 2>/dev/null || echo unknown) in $ROOT"
...
step "Rocket Mailer $VERSION installed"
