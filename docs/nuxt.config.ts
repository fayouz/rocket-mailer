  ...
  icon: {
    ...
    clientBundle: {
      ...
      icons: [
        ...
        'lucide:plug', 'lucide:signpost', 'lucide:layers', 'lucide:mailbox', 'lucide:panels-top-left', 'lucide:refresh-cw', 'lucide:palette', 'simple-icons:nuxtdotjs', 'simple-icons:symfony',
