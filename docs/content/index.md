---
title: Rocket Mailer
description: Envoyez des emails riches depuis Rocket Mailer ou directement depuis vos propres applications, grâce au composeur embarquable.
seo:
  title: Rocket Mailer — Documentation
---
...
---
#description
Rocket Mailer centralise l'envoi d'emails : composeur en texte enrichi, templates visuels versionnés, comptes LDAP, et un **composeur embarquable** que vos applications intègrent en quelques lignes, en toute sécurité.
...
#default
  ...
  <script>
    RocketMailer.mount('#mailer', {
      ...
      applicationId: '0199…',
      getToken: () => fetch('/rocket-mailer/token')
